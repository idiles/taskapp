...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Task.archived'
        db.add_column('tasks_task', 'archived', orm['tasks.task:archived'])
        
        # Changing field 'Task.due_date'
        # (to signature: django.db.models.fields.DateField(null=True, blank=True))
        db.alter_column('tasks_task', 'due_date', orm['tasks.task:due_date'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Task.archived'
        db.delete_column('tasks_task', 'archived')
